      ...
      <div className="absolute bottom-0 left-0 right-0 py-2 bg-slate-900/80 backdrop-blur-sm border-t border-slate-800/50">
        <div className="container mx-auto px-4">
          <a href="https://jiy.co.il" target="_blank" rel="noopener noreferrer" className="block text-center mb-1.5 group">
            <span className="text-slate-500/60 text-[10px] md:text-xs group-hover:text-slate-400 transition-colors whitespace-nowrap">רוצים גם מערכת הזמנות משוכללת לעסק שלכם?</span>
          </a>
